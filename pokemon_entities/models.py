...
class Pokemon(models.Model):
    ...
    title_en = models.CharField('Название покемона англ.',max_length=50, blank=True, default=' ')
    title_jp = models.CharField('Название покемона яп.',max_length=50, blank=True, default=' ')
